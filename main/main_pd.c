...
/**
 * This one use to receive data and control car
 * 
*/
...
/**
 * @brief Demodulate the OOK
 * @param encode: pointer to the machester data
 * @param data: pointer to the demolutaion data
 * 
*/
